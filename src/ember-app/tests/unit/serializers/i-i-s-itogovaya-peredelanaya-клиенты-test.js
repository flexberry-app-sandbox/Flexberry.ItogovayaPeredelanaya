...
moduleForModel('i-i-s-itogovaya-peredelanaya-клиенты', 'Unit | Serializer | i-i-s-itogovaya-peredelanaya-клиенты', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-itogovaya-peredelanaya-клиенты',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
