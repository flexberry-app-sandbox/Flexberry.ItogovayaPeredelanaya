...
moduleForModel('i-i-s-itogovaya-peredelanaya-организации', 'Unit | Serializer | i-i-s-itogovaya-peredelanaya-организации', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-itogovaya-peredelanaya-организации',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
