...
moduleForModel('i-i-s-itogovaya-peredelanaya-менеджер', 'Unit | Serializer | i-i-s-itogovaya-peredelanaya-менеджер', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-itogovaya-peredelanaya-менеджер',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
