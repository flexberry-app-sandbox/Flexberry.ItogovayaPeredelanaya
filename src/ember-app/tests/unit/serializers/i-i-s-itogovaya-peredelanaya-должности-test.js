...
moduleForModel('i-i-s-itogovaya-peredelanaya-должности', 'Unit | Serializer | i-i-s-itogovaya-peredelanaya-должности', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-itogovaya-peredelanaya-должности',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
