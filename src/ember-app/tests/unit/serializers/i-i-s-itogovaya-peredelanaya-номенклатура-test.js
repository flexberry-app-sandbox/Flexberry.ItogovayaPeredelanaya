...
moduleForModel('i-i-s-itogovaya-peredelanaya-номенклатура', 'Unit | Serializer | i-i-s-itogovaya-peredelanaya-номенклатура', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-itogovaya-peredelanaya-номенклатура',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
