...
moduleForModel('i-i-s-itogovaya-peredelanaya-сотрудники', 'Unit | Serializer | i-i-s-itogovaya-peredelanaya-сотрудники', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-itogovaya-peredelanaya-сотрудники',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
