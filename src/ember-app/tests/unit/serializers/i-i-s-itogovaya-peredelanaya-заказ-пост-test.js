...
moduleForModel('i-i-s-itogovaya-peredelanaya-заказ-пост', 'Unit | Serializer | i-i-s-itogovaya-peredelanaya-заказ-пост', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-itogovaya-peredelanaya-заказ-пост',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
