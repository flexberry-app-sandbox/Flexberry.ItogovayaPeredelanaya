...
moduleForAcceptance('[AGAT] Acceptance | i i s itogovaya peredelanaya план закупок l');

test('testing i-i-s-itogovaya-peredelanaya-план-закупок-l', function(assert) {
