...
moduleForAcceptance('[AGAT] Acceptance | i i s itogovaya peredelanaya номенклатура l');

test('testing i-i-s-itogovaya-peredelanaya-номенклатура-l', function(assert) {
