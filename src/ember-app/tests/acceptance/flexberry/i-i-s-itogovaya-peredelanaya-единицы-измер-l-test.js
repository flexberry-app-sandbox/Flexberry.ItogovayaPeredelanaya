...
moduleForAcceptance('[AGAT] Acceptance | i i s itogovaya peredelanaya единицы измер l');

test('testing i-i-s-itogovaya-peredelanaya-единицы-измер-l', function(assert) {
