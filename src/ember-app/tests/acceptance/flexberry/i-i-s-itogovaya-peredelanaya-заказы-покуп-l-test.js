...
moduleForAcceptance('[AGAT] Acceptance | i i s itogovaya peredelanaya заказы покуп l');

test('testing i-i-s-itogovaya-peredelanaya-заказы-покуп-l', function(assert) {
