...
namespace IIS.Itogovaya_peredelanaya
{
    ...
    public class План : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itogovaya_peredelanaya.ПланЗакупок fПланЗакупок;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Itogovaya_peredelanaya.ПланЗакупок.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПланЗакупок"})]
        public virtual IIS.Itogovaya_peredelanaya.ПланЗакупок ПланЗакупок
        {
            get
            {
                ...
                IIS.Itogovaya_peredelanaya.ПланЗакупок result = this.fПланЗакупок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланE", typeof(IIS.Itogovaya_peredelanaya.План));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПлан : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Itogovaya_peredelanaya.DetailArrayOfПлан members)

        // *** End programmer edit section *** (IIS.Itogovaya_peredelanaya.DetailArrayOfПлан members)
        ...
        /// </summary>
        public DetailArrayOfПлан(IIS.Itogovaya_peredelanaya.ПланЗакупок fПланЗакупок) : 
                base(typeof(План), ((ICSSoft.STORMNET.DataObject)(fПланЗакупок)))
        {
        }
        
        public IIS.Itogovaya_peredelanaya.План this[int index]
        {
            get
            {
                return ((IIS.Itogovaya_peredelanaya.План)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Itogovaya_peredelanaya.План dataobject)
        {
