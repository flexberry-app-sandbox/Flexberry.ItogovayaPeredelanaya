...
namespace IIS.Itogovaya_peredelanaya
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itogovaya_peredelanaya.ОтчетОЗак fОтчетОЗак;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Itogovaya_peredelanaya.ОтчетОЗак.
        /// </summary>
        ...
        [TypeUsage(new string[] {
                "IIS.Itogovaya_peredelanaya.ЗаказПост",
                "IIS.Itogovaya_peredelanaya.ОтчетОЗак"})]
        public virtual IIS.Itogovaya_peredelanaya.ОтчетОЗак ОтчетОЗак
        {
            get
            {
                ...
                IIS.Itogovaya_peredelanaya.ОтчетОЗак result = this.fОтчетОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Itogovaya_peredelanaya.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Itogovaya_peredelanaya.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Itogovaya_peredelanaya.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Itogovaya_peredelanaya.ОтчетОЗак fОтчетОЗак) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fОтчетОЗак)))
        {
        }
        
        public IIS.Itogovaya_peredelanaya.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Itogovaya_peredelanaya.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Itogovaya_peredelanaya.ТЧЗаказ dataobject)
        {
