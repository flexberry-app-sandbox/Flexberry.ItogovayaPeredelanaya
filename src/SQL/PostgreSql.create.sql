...
CREATE TABLE ТЧЗаказПок (
 primaryKey UUID NOT NULL,
 Количество INT NULL,
 Номенклатура UUID NOT NULL,
 ЗаказыПокуп UUID NOT NULL,
 PRIMARY KEY (primaryKey));
...
CREATE INDEX Index19e381ecd2afb4a9cb1acc2bc535a389684ef502 on ПланЗакупок (Склады); 
 ...
 ALTER TABLE Менеджер ADD CONSTRAINT FK98feeacefa37e4f2af7c374f43f7e68edfdbb039 FOREIGN KEY (Сотрудники) REFERENCES Сотрудники; 
CREATE INDEX Index98feeacefa37e4f2af7c374f43f7e68edfdbb039 on Менеджер (Сотрудники); 

 ALTER TABLE ЗаказыПокуп ADD CONSTRAINT FKf5e22e6e51f1782882611fcc66fcf879a6b69565 FOREIGN KEY (Клиенты) REFERENCES Клиенты; 
CREATE INDEX Indexf5e22e6e51f1782882611fcc66fcf879a6b69565 on ЗаказыПокуп (Клиенты); 
...
CREATE INDEX Index83a28cd0773d73ef37c6d2c02431e2b1fdf21639 on ОтчетОЗак (Контрагенты); 
 ...
 ALTER TABLE ОтчетОЗак ADD CONSTRAINT FKe8fa31769eb66dbf3b753e44754449b6a1a80608 FOREIGN KEY (Менеджер) REFERENCES Менеджер; 
CREATE INDEX Indexe8fa31769eb66dbf3b753e44754449b6a1a80608 on ОтчетОЗак (Менеджер); 
...
CREATE INDEX Index581902986d627b9e95c6034c9024f949018378f2 on ОтчетОЗак (Склады); 
 ...
 ALTER TABLE ЗаказПост ADD CONSTRAINT FK730597a42ec12deb56e7b54c675b3bfafda6c1fb FOREIGN KEY (Менеджер) REFERENCES Менеджер; 
CREATE INDEX Index730597a42ec12deb56e7b54c675b3bfafda6c1fb on ЗаказПост (Менеджер); 
...
CREATE INDEX Indexac26b2cb8ba1aec8a1caf7b116e00c2496cc7d9b on ТЧЗаказ (ОтчетОЗак_m1); 
 ...
 ALTER TABLE ТЧЗаказПок ADD CONSTRAINT FK9ac376a58ac654c2af42e5f974c0af8b8781f27d FOREIGN KEY (Номенклатура) REFERENCES Номенклатура; 
CREATE INDEX Index9ac376a58ac654c2af42e5f974c0af8b8781f27d on ТЧЗаказПок (Номенклатура); 

 ALTER TABLE ТЧЗаказПок ADD CONSTRAINT FK8626cbc60a82e03ba47a388a5a5dc8151e6b34a3 FOREIGN KEY (ЗаказыПокуп) REFERENCES ЗаказыПокуп; 
CREATE INDEX Index8626cbc60a82e03ba47a388a5a5dc8151e6b34a3 on ТЧЗаказПок (ЗаказыПокуп); 
